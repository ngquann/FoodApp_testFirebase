...
const Cart = () => {
    ...
    return (
        <motion.div
            ...
            className="fixed top-0 right-0 w-full md:w-375 bg-white h-screen drop-shadow-md flex flex-col z-[101]">
...

            {
                cartItems && cartItems.length > 0 ? (
                    <div className="w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col">
                        <div className="w-full h-340 md:h-42 px-6 py-10 flx flex-col gap-3 overflow-y-scroll scrollbar-none">
                            {
