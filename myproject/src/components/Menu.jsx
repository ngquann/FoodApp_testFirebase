                ...
                <div className="w-full flex items-center justify-start lg:justify-center gap-8 mt-6 overflow-x-scroll scrollbar-none">
                    {
                        categories && categories.map(category => (
                            ...
                            w-24 min-w-[94px] h-28 cursor-pointer rounded-lg drop-shadow-xl flex flex-col gap-3 items-center justify-center hover:bg-red-600`}
                                ...
                                <div className={`w-10 h-10 rounded-full drop-shadow-lg ${filter === category.urlParamName ? "bg-white" : "bg-cartNumBg"} group-hover:bg-card flex items-center justify-center`}>
